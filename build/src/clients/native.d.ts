...
export declare function getUserFeeTier(payload: string): Promise<string>;
...
export declare function getStakingRewards(payload: string): Promise<string>;
export declare function getCurrentUnstaking(payload: string): Promise<string>;
...
export declare function cctpMultiMsgWithdraw(cosmosPayload: string): Promise<string>;
export declare function getWithdrawalCapacityByDenom(payload: string): Promise<string>;
export declare function getWithdrawalAndTransferGatingStatus(perpetualId: number): Promise<string>;
export declare function subaccountTransfer(payload: string): Promise<string>;
export declare function signCompliancePayload(payload: string): Promise<string>;
export declare function signPushNotificationTokenRegistrationPayload(payload: string): Promise<string>;
export declare function setSelectedGasDenom(gasDenom: string): Promise<string>;
export declare function getMegavaultOwnerShares(payload: string): Promise<string>;
export declare function getMegavaultWithdrawalInfo(sharesToWithdraw: bigint): Promise<string>;
export declare function depositToMegavault(subaccountNumber: number, amountUsdc: number): Promise<string>;
export declare function withdrawFromMegavault(subaccountNumber: number, shares: number, minAmount: number): Promise<string>;
